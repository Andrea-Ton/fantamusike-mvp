                                                ...
                                                <div className="col-span-7 flex items-center gap-4">
                                                    ...
                                                    <div className="flex flex-col min-w-0 flex-1 overflow-hidden">
                                                        <div className="marquee-container w-full">
                                                            <span className={`font-black italic tracking-tighter text-base truncate block group-hover:animate-marquee ${isCurrentUser ? 'text-white' : 'text-gray-300 group-hover:text-white'}`}>
                                                                {entry.username}
                                                            </span>
                                                        </div>
                                                        {isCurrentUser && (

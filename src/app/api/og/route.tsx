...
async function generateImage(data: any) {
    ...
    return new ImageResponse(
        (
            ...
            >
                {/* Background elements - REPLACED BLUR WITH GRADIENT */}
                ...
                {/* Roster Grid (2x2) */}
                <div style={{ display: 'flex', flexWrap: 'wrap', width: '500px', justifyContent: 'center', gap: '26px', marginBottom: '26px', zIndex: 10 }}>

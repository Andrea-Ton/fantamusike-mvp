    ...
    return (
        <nav className="fixed top-0 w-full z-50 px-6 py-4 flex justify-between items-center bg-[#0b0b10]/50 backdrop-blur-xl border-b border-white/5">
            ...
            <div className="flex items-center gap-4">
                {user ? (
                    <Link href="/dashboard">
                        <button className="px-5 py-2 rounded-full bg-white/10 border border-white/5 text-sm font-bold text-white hover:bg-white/20 transition-all backdrop-blur-md cursor-pointer">
                            La mia Dashboard
                        </button>
                    </Link>
                ) : (
